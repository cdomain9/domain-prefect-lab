# Prefect dbt Lab Starter
To begin this lab, please open this repository in a codespace by clicking this [link](https://github.com/codespaces/new?template_repository=analytics8/prefect-dbt-starter). You can then follow along with the instructions found in the [instructions](./instructions/00_Orchestration_Prefect_Intro.md) folder.
