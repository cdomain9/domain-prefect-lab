...
Orchestration is the automation and management of data workflow execution betweem various sources and components of a data pipeline. In today's landscape of the modern data stack, which consists of a variety of tools that integrate together, orchestration tools are an important part of helping businesses create, automate and monitor end-to-end worfklows across the entire data pipeline no matter what tech stack is being used. 
